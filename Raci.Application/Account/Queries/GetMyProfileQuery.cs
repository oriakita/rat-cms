...
{
    public class GetMyProfileQuery : IRequest<GetMyProfileQuery.ResponseDto>
    {
        public Guid AccountGuid { get; set; }

        public class Handler : IRequestHandler<GetMyProfileQuery, ResponseDto>
        {
            ...
            public async Task<ResponseDto> Handle(GetMyProfileQuery query, CancellationToken cancellationToken)
            {
                try
                {
                ...
                {
                    throw new ApplicationException($"Lỗi khi truy cập thông tin cá nhân");
                }
            }
        }
